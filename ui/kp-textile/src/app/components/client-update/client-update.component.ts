  ...
  submitData() {
    ...
    this.clientService.updateClient(this.clientId, this.updateClientForm.value).subscribe({
      next: (data) => {
        ...
        this.toastr.info('<span class="tim-icons icon-bell-55" [data-notify]="icon"></span> Clinet update.', 'Success', {
        ...
        this.toastr.info('<span class="tim-icons icon-bell-55" [data-notify]="icon"></span> Clinet was not updated.', 'Error', {
          disableTimeOut: false,
          timeOut:2000,
          closeButton: true,
          enableHtml: true,
